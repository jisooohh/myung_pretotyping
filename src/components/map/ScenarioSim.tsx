...
const TIMELINE: Item[] = [
  { type: 'scene', n: 1, text: '6개월 더 준비하기로 마음먹고, 퇴근 후 토이프로젝트를 시작해요. 처음엔 \'이게 의미가 있나\' 싶지만, 庚金의 압박 속에서 만든 결과물이 오히려 단단해요. 木이 칼에 다듬어지는 시기거든요.' },
  {
    ...
    q: '가장 먼저 무엇을 할까요?',
    opts: [
      { label: '포트폴리오 사이트부터 만든다', scenario: '작은 포트폴리오를 빠르게 공개하고, 지원서와 외주 문의가 동시에 열리는 흐름' },
      { label: '지인에게 첫 프로젝트를 부탁한다', scenario: '지인 외주 1건으로 시장 감각과 첫 매출을 확인하는 흐름' },
      { label: '코딩테스트 스터디에 다시 들어간다', scenario: '스터디 루틴을 회복해 정규직 지원력을 다시 끌어올리는 흐름' },
    ],
  },
  ...
  { type: 'scene', n: 3, text: '그 사이 정규직 면접 제안도 하나 들어와요. 이제 선택지가 생겼어요 — 안정적인 취업이냐, 프리랜서 확장이냐. 6개월 전 \'도망치듯\' 전향하려던 것과는 완전히 다른 위치예요.' },
  {
    ...
    q: '어디로 마음이 기울어요?',
    opts: [
      { label: '안정적인 정규직을 잡는다', scenario: '정규직 제안을 받아 안정성을 확보하고 사이드 프로젝트를 천천히 남기는 흐름' },
      { label: '프리랜서를 본격화한다', scenario: '외주 경험을 발판으로 프리랜서 확장에 집중하는 흐름' },
      { label: '둘 다 협상 카드로 쓴다', scenario: '정규직과 프리랜서 가능성을 모두 들고 더 나은 조건을 협상하는 흐름' },
    ],
  },
